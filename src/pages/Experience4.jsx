...
function Experience4() {
  ...
  const t = translations[language].experience4; // Utilisez la clé "home" pour accéder aux traductions spécifiques à la page d'accueil
    ...
    <>
      <div className="container container-rating">
        <section id="contact-form" class="py-3">
          <div class="container">
            <h1 class="l-heading">
              <span class="text-primary">{t.titleSpan}</span>
              {t.title}
            </h1>
            <form>
        ...
        <Link to={"/experience-5"} className="btn btn-skip">
          {t.btnSkip}
        </Link>
      </div>
    </>
