...
function Experience2() {
  ...
  const t = translations[language].experience2; // Utilisez la clé "home" pour accéder aux traductions spécifiques à la page d'accueil
  ...
  <section id="contact-form" class="py-3">
    ...
    <Link to={"/experience-3"} className="btn btn-skip">{t.btnSkip}</Link>
      </div>
    </>
  )
}
